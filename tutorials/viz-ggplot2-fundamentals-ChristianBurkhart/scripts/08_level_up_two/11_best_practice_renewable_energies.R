...
renewable_energy %>% 
  ...
  geom_line(data = world_bank_countries |> 
  ...
  labs(
    title = paste("Scandinavian countries consume the most renewable energies in",
                  "Europe.<br />",
                  "In particular <span style='color: #16A34A'><strong>Norway</strong></span>",
...
ggsave(
  filename = "tutorials/ggplot2-fundamentals/final_plots/renewable_energies.png",
  dpi = 320,
  width = 12,
  height = 8
)
